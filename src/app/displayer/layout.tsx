...
import News from "../NewsAndBlog/page";
import NewsLetter from "../NewsLetter/page";
import Footer from "../footer/page";

interface child {
  children: ReactNode;
  jobCategoryOfTheDay: ReactNode;
}

export default function Layout({ children, jobCategoryOfTheDay }: child) {
  return (
    <div>
      <div>{children}</div>
